...
function STLViewer(elem, model) {
    ...
    (new THREE.STLLoader()).load(model, function (geometry) {
        var material = new THREE.MeshPhongMaterial({ color: 0x707070, specular: 100, shininess: 100 });
        var mesh = new THREE.Mesh(geometry, material);
	// in 3D printing land, Z is up. Here, Y is up.
...
//        mesh.position.z = -1 * middle.z;
        ...
        camera.position.y = largestDimension * 1.25;
